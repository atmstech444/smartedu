...
const CourseDetailsComponent: React.FC<CourseDetailsProps> = ({
  ...
  const options: OptionsType<any> = lectures.map(
    (lecturer: { id: any; first_name: any; last_name: any }) => ({
      value: lecturer.id,
      ...
      <div className="rounded-[32px] shadow-shad p-5 mr-5">
        ...
        <div className="my-2">
          <video controls ref={videoRef}>
            <source
              src={`https://smarteducation.shop/smarteducation_backend/public/${data.intro}`}
              type="video/mp4"
            />
