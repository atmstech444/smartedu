...
const CourseDetails: React.FC<CourseDetailsProps> = ({
  ...
  return (
    <div className="mt-16 flex flex-col items-start gap-6 pr-4">
      <h1 className="self-center text-dark text-xl font-normal">
        კურსის დეტალები
      </h1>
      ...
      <div className="rounded-[32px] shadow-shad p-5 mr-5">
        ...
        {errorMessages.intro && (
          <p className="text-red pt-2">{errorMessages.intro[0]}</p>
        )}
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              id="priceInput"
              type="text"
              className="border border-[#c1c1c1] rounded-[32px] outline-none pl-2"
            />
            {errorMessages.price && (
              <p className="text-red pt-2">{errorMessages.price[0]}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {errorMessages.lecturer && (
              <p className="text-red pt-2">{errorMessages.lecturer[0]}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {errorMessages.duration && (
              <p className="text-red pt-2">{errorMessages.duration[0]}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {errorMessages.language && (
              <p className="text-red pt-2">{errorMessages.language[0]}</p>
            )}
          </div>
        </div>
      </div>
