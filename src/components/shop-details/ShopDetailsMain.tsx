        ...
        <div className="container custome-container">
          <div className="row ">
            <div className="col-lg-4 col-md-12">
              <div className="product-details-img mb-30">{product?.image && <Image src={product?.image} style={{ width: "100%", height: "auto" }} alt="product img" />}</div>
            </div>
            <div className="col-lg-6 col-md-12">
              <div className="product-side-info mb-30">
                <h4 className="product-name mb-10"> {product?.title} </h4>
                <span className="product-price">{product?.price === 0 ? "FREE" : `$${product?.price}.00`}</span>
                <p>Matent maecenas nec massa viverra aci ute litora aliquam habitant proin commodo bibendum rutru habitant est magnis quisque aliquet congue vesti bulum suscipi erose tellus odio elite purus feugiat prim libero senes nisie gravia</p>
